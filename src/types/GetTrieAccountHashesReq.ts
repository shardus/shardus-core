...
export function serializeGetTrieAccountHashesReq(stream: VectorBufferStream, req: HashTrieReq, root = false): void {
  if(root) {
...
export function deserializeGetTrieAccountHashesReq(stream: VectorBufferStream): HashTrieReq {
