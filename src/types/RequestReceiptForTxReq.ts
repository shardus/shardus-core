...
export type RequestReceiptForTxReqSerialized = { txid: string; timestamp: number }
...
export function deserializeRequestReceiptForTxReq(stream: VectorBufferStream): RequestReceiptForTxReqSerialized {
