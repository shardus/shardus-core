...
const apoptosisGossipRoute: P2P.P2PTypes.GossipHandler<
  P2P.ApoptosisTypes.SignedApoptosisProposal
...
export function validateRecordTypes(rec: P2P.ApoptosisTypes.Record): string {
  const err = validateTypes(rec, {apoptosized: 'a'})
  if (err) return err
...
function addProposal(
  proposal: P2P.ApoptosisTypes.SignedApoptosisProposal
): boolean {
