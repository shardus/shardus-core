...
var totalListenedTransactions = 0;
...
*/
  ...
  _attemptCreateAppliedListener() {
    ...
    this._registerListener(this.stateManager.eventEmitter, 'txApplied', (transaction) => {
      // totalListenedTransactions++
      // this.mainLogger.info('Listener has captured transaction : ', transaction,' total transactions : ', totalListenedTransactions )
