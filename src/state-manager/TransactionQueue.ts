...
var totalTx = 0;
var totalTxrouteAndQueueAcceptedTransaction = 0;
var totalTxprocessAcceptedTxQueue = 0;
...
class TransactionQueue {
  ...
  async commitConsensedTransaction(queueEntry: QueueEntry): Promise<CommitConsensedTransactionResult> {
    ...
    // this.mainLogger.info('Transaction Injected : ',acceptedTX, ' total transactions applied : ', totalTx)
  ...
  routeAndQueueAcceptedTransaction(acceptedTx: AcceptedTx, sendGossip: boolean = true, sender: Shardus.Node | null, globalModification: boolean, noConsensus: boolean): string | boolean {
    ...
    try {
      ...
      try {
        ...
        totalTxrouteAndQueueAcceptedTransaction++
        this.mainLogger.info('Transaction Injected routeAndQueueAcceptedTransaction: ',totalTxrouteAndQueueAcceptedTransaction)
            ...
            if (this.processQueue_accountSeen(seenAccounts, queueEntry) === false) {
              ...
              try {
                ...
                if (canCommitTX) {
                  ...
                  totalTxprocessAcceptedTxQueue++
                  this.stateManager.eventEmitter.emit('total tx TxprocessAcceptedTxQueue : ',totalTxprocessAcceptedTxQueue  )
