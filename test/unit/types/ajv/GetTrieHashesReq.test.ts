import { initGetTrieHashesReq } from '../../../../src/types/ajv/GetTrieHashesReq'
...
describe('GetTrieHashesReq', () => {
  beforeEach(() => {
    jest.clearAllMocks()
  })

  describe('initGetTrieHashesReq', () => {
    ...
    it('should not throw any errors during initialization', () => {
      expect(() => initGetTrieHashesReq()).not.toThrow()
    })
  })
