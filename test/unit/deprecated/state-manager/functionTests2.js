...
console.log(
  `blob.activeNodes.length: ${testInput.activeNodes.length} dupes.length: ${dupes.length} activeList.length:${activeList.length} nodebyID.length:${nodebyID.length}`
)
