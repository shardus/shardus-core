...
let { allPassed, allPassedMetric2, singleVotePartitions, multiVotePartitions, badPartitions, totalTx } =
  partitionStats.processTxStatsDump(consoleStream, partitionStats.txStatsTallyFunction, statsLines)
