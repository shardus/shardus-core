...
const output = StateManager.solveHashSets(hashSetList, 10)
...
const output2 = StateManager.solveHashSets(hashSetList2, 40, 0.625, output)
...
hashSetList[0].extraMap.sort((a, b) => {
  return a - b
})

console.log(JSON.stringify(hashSetList[0].extraMap))
if (hashSetList2.length > 0) {
  hashSetList2[0].extraMap.sort((a, b) => {
    return a - b
  })
