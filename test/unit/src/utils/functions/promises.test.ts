...
describe('promises', () => {
  ...
  describe('robustPromiseAll', () => {
    it('should handle all resolved promises', async () => {
      const promises = [Promise.resolve('success1'), Promise.resolve('success2'), Promise.resolve('success3')]
    ...
    it('should handle mixed resolved and rejected promises', async () => {
      const error1 = new Error('error1')
      const promises = [Promise.resolve('success1'), Promise.reject(error1), Promise.resolve('success2')]
    ...
    it('should handle promises with different types', async () => {
      const promises = [Promise.resolve(42), Promise.resolve(100), Promise.resolve(200)]
  ...
  describe('groupResolvePromises', () => {
    ...
    it('should resolve with success when minimum wins reached', async () => {
      const promises = [createDelayedPromise(1, 10), createDelayedPromise(2, 20)]
    ...
    it('should handle promise errors as losses', async () => {
      ...
      const promises = [createDelayedRejection(error1, 10), createDelayedRejection(error2, 20)]
    ...
    it('should handle empty promise array', async () => {
      ...
      const raceResult = await Promise.race([groupResolvePromises(promises, (val) => val > 0, 1, 1), timeoutPromise])
