...
describe('TypeIdentifierEnum', () => {
  ...
  it('should be usable for type mapping', () => {
    ...
    requestResponseMap[TypeIdentifierEnum.cGetAccountDataWithQueueHintsReq] =
      TypeIdentifierEnum.cGetAccountDataWithQueueHintsResp
    ...
    // Test a few mappings
    expect(getResponseTypeForRequest(TypeIdentifierEnum.cApoptosisProposalReq)).toBe(
      TypeIdentifierEnum.cApoptosisProposalResp
    )
    expect(getResponseTypeForRequest(TypeIdentifierEnum.cGetAccountDataReq)).toBe(
